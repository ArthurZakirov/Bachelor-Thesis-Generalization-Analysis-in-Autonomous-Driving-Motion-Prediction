...
def example(kittiDir=None, drive=None):
    ...
    for iTracklet, tracklet in enumerate(tracklets):
        print
        'tracklet {0: 3d}: {1}'.format(iTracklet, tracklet)
        ...
        for tracklet_data in tracklet:
            translation, rotation, state, occlusion, truncation, amtOcclusion, amtBorders, absoluteFrameNumber = tracklet_data
